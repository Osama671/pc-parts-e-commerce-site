function CardJs(elem) {
  ;(this.elem = jQuery(elem)),
    (this.captureName = this.elem.data('capture-name')
      ? this.elem.data('capture-name')
      : !1),
    (this.iconColour = this.elem.data('icon-colour')
...
!(function ($) {
  ...
  (CardJs.caretStartPosition = function (element) {
    return 'number' == typeof element.selectionStart
  ...
  (CardJs.prototype.initNameInput = function () {
    ...
    CardJs.elementHasAttribute(this.nameInput, 'onkeydown') ||
      this.nameInput.attr('onkeydown', 'return /[a-z]/i.test(event.key)')
  }),
  ...
  (CardJs.prototype.setupExpiryInput = function () {
    ...
    if (this.EXPIRY_USE_DROPDOWNS) {
      ...
      ;(expiryInput = $('<div></div>')),
        ...
        this.expiryMonthYearInput.attr('requried', '')
      var $this = this
