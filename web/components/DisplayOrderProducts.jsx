      ...
      <div className="product-details">
        <div className="d-flex justify-content-between align-items-center">
          ...
          <div className="product">
            <a className="product-link" href={`/product/${productInfo.details.id}`}>
        ...
        <div className="d-flex justify-content-between px-4">
          ...
          <div className="item-price">{productService.renderPrice(productInfo.details.price * productInfo.quantity)}</div>
        </div>
      </div>
    </li>
  )
